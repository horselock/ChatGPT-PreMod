...
# Changelog
- 2.4.0 - Saved reds now also record the conversation ID, whether it was your request or the response, and when it was saved. Messages saved by older versions still restore normally. This is groundwork for cleaning up saved messages that no longer belong to any conversation.
